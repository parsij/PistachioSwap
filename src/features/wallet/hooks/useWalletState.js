...
/**
 * Reconciles AppKit and Wagmi account/chain state against the swap's expected chain.
 * @param {number} expectedChainId Chain required by the active sell token.
 * @returns {{address: string|null, isConnected: boolean, chainId: number|null, isCorrectNetwork: boolean}} Normalized wallet state.
 * @sideEffects Subscribes to AppKit/Wagmi state; does not prompt or switch the wallet.
 */
