...
/** Parses a user-entered percentage into basis points without floating-point rounding. */
...
/** Formats integer basis points as the percentage label shown by settings UI. */
...
/** Resolves custom, provider-recommended, and default slippage in precedence order. */
...
/** Returns the canonical persisted swap-settings shape with fail-closed defaults. */
...
/** Reads browser settings and resets intentionally session-only slippage fields. */
...
/** Persists canonical non-session settings and returns the normalized value. */
