 ...
 * @sideEffects Radix moves focus and mounts under `document.body`; callbacks own wallet/transaction work.
 */
                    ...
                    >
                        ...
                        <div className="cross-chain-review-actions">
                            ...
                            <button type="button" className="primary" disabled={confirmDisabled} onClick={onConfirm}>
                                {preparation.status === 'preparing' ? 'Preparing estimate...' : 'Confirm swap'}
                            </button>
                        </div>
                    </motion.section>
                </Dialog.Content>
