...
/**
 * Renders the Gas Assist approval/signature review dialog.
 * @param {object} props Dialog state, token/amount summary, close and async confirm callbacks.
 * @returns {import('react').ReactElement} Portaled Radix dialog.
 * @sideEffects Focus/portal changes and explicit callback invocation; wallet work belongs to `onConfirm`.
 */
