const messages = {
    ...
    SPONSORED_GAS_CAP_EXCEEDED: 'No usable route found.',
    SPONSORED_NATIVE_GAS_CAP_EXCEEDED: 'No usable route found.',
    ...
    SPONSORED_ROUTE_UNAVAILABLE: 'No usable route found.',
