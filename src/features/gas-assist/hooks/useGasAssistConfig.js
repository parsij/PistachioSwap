...
/**
 * Loads and caches backend-authoritative Gas Assist configuration when eligible.
 * @param {{quoteEndpoint: string, enabled: boolean}} config Request configuration.
 * @returns {{status: string, config: object|null, error: unknown, refresh: Function}} Configuration state/API.
 * @sideEffects Performs an abortable backend request; does not call a wallet.
 */
