...
/** Returns cryptographically secure bytes of the requested positive length. */
...
/** Encodes byte-like input as unpadded base64url text. */
...
/** Decodes canonical base64url text and optionally enforces an exact byte length. */
...
/** Normalizes supported buffer views into an independent `Uint8Array`. */
...
/** Decodes UTF-8 bytes and rejects malformed sequences. */
...
/** Serializes supported data with stable recursive object-key ordering. */
export function canonicalJson(value) {
    return JSON.stringify(canonicalValue(value))
}

/** Overwrites a mutable byte buffer in place when present; returns no value. */
