...
import { detectPasskeyCapabilities, resolvePistachioRpId } from '../services/passkeyCapabilities.js'
import { encryptDiagnosticPayload, unlockDiagnosticPayload } from '../services/passkeyDiagnostic.js'
import { wipeBytes } from '../services/passkeyEncoding.js'
import { getPistachioWalletFlags } from '../services/featureFlags.js'
import { getPrfForVaultWrap, registerPrfPasskey } from '../services/passkeyService.js'
import { clearDiagnosticVault, readPreference, writePreference } from '../services/vaultStorage.js'
...
/**
 * Renders development-only passkey capability, PRF, encryption, and storage diagnostics.
 * @returns {import('react').ReactElement|null} Diagnostic panel when existing DEV flags enable it.
 * @sideEffects Explicit actions may prompt WebAuthn and read/write/clear diagnostic storage.
 * @security Diagnostic success is not proof of production wallet security or signing behavior.
 */
