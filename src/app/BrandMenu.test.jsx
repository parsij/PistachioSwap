...
describe('brand menu', () => {
    ...
    describe('desktop', () => {
        ...
        it('opens when hovering the brand while keeping the logo as a landing link', () => {
            ...
            expect(screen.getAllByRole('link', { name: /Gas Assist/ })
                .every((link) => link.getAttribute('href') === '/gas-assist/'))
                .toBe(true)
    ...
    describe('mobile', () => {
        ...
        it('keeps the logo as a landing link and opens a bottom sheet from the hamburger', () => {
            ...
            expect(screen.getByRole('link', { name: /^Gas Assist$/ }).getAttribute('href')).toBe('/gas-assist/')
            ...
            expect(screen.getByRole('link', { name: /Pistachio Wallet/ }).getAttribute('href')).toBe('/wallet/')
        })
