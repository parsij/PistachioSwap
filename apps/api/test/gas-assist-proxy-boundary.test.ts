...
describe('Gas Assist public proxy boundary', () => {
    it('exposes only explicitly reviewed route shapes', () => {
        ...
        expect(isPublicGasAssistProxyRoute('POST', '/v1/sponsorship/orders/order_123/atomic/permit')).toBe(true)
        expect(isPublicGasAssistProxyRoute('POST', '/v1/sponsorship/orders/order_123/atomic/submit')).toBe(true)
        expect(isPublicGasAssistProxyRoute('POST', '/v1/sponsorship/alchemy/sponsorship-webhook')).toBe(true)
